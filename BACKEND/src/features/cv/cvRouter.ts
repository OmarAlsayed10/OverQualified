...
import { uploadToMemory, uploadMdToMemory, uploadAvatar } from "../../shared/media/importService";
import { authenticateToken, optionalAuth } from "../../middleware/validateJWTMiddleware";
import { requireProUser, requireSubscribedUser } from "../../middleware/roleMiddleware";
import { requireCredits, withUserContext } from "../../middleware/creditMiddleware";
import { careerMatchController, careerMatchLimitsController } from "../careerMatch/careerMatchController";

import { importProjectFromUrlController, importProjectFromFileController } from "../projectImport/projectImportController";
...
} from "../roadmap/roadmapController";
...
router.post("/optimize-cv-length", authenticateToken, aiLimiter, requireSubscribedUser, requireCredits, withUserContext, optimizeCvLengthController);
router.post("/cv-photo", authenticateToken, uploadAvatar.single("photo"), uploadCvPhotoController);
router.post("/edit-field-ai", authenticateToken, aiLimiter, requireSubscribedUser, requireCredits, withUserContext, editFieldWithAIController);
