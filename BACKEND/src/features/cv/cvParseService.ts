...
import { ProjectOwnership, coerceProjectOwnership } from "../../shared/projectOwnership";
...
const EDUCATION_STATUSES = new Set(["graduated", "undergraduate"]);

// Entries written before the status existed, and anything the model invents, read as a
// finished degree — that was the only case the builder used to support.
const educationStatus = (value: any): "graduated" | "undergraduate" =>
  (EDUCATION_STATUSES.has(value) ? value : "graduated");
...
Return ONLY this exact JSON shape:
{
  ...
  "education": [ { "status": "graduated | undergraduate", "institution": "", "degree": "", "location": "", "startYear": "", "endYear": "", "description": "" } ],
