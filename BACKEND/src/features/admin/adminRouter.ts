...
} from "../jobRadar/jobCatalogController";
import {
  adminJobSubmissionsController,
  adminReviewJobSubmissionController,
} from "../jobRadar/jobSubmissionController";
import {
  adminBoardSourcesController,
  adminCreateBoardSourceController,
  adminDeleteBoardSourceController,
  adminUpdateBoardSourceController,
} from "../jobRadar/jobBoardSourceController";
import {
...
router.get("/job-board-sources", adminBoardSourcesController);
router.post("/job-board-sources", adminCreateBoardSourceController);
router.patch("/job-board-sources/:id", adminUpdateBoardSourceController);
router.delete("/job-board-sources/:id", adminDeleteBoardSourceController);
